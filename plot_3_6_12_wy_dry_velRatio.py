...
PAIRS = [
    ...
    ("ts_dry1_vel_myr",        "ts_dry2_vel_myr",        "Dry",    "Dry months"),
]
...
with fig.subplot(
    ...
    fig.basemap(region=SCATTER_REGION, projection=SCATTER_PROJ, frame=["wSrt+tDry Months", "xa", "ya"], panel=True)
    plot_one_panel(fig, df, "Dry", CAT_ORDER)
...
labels_for_rows = ["Dry","WY", "EQ_12m","EQ_6m", "EQ_3m"]
...
out_base = f"{fig_dir}/Fig_9_VelRatio_many_minvel{VEL_MIN_CM}_multiple{VEL_MULTIPLE}"
