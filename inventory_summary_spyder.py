...
CONFIG = {
    "columns": {
        "slope": None,          # e.g., "ls_mean_slope"
        "aspect": None,         # e.g., "ls_mean_aspect"
        "elevation": None,      # e.g., "ls_mean_height" (m)
        "area": None,           # e.g., "ls_area_m2" (m^2)
        "length": None,         # e.g., "ls_max_diameter_m"
        "width": None,          # e.g., "ls_min_diameter_m"
        "aspect_ratio": None,   # optional if length/width not present
        "velocity": None,       # e.g., "ts_linear_vel_myr" (m/yr)
